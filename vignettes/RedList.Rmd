...
workflow <- startWorkflow(
        Projection = '+proj=tmerc +lat_0=58 +lon_0=6.05625 +k=1 +x_0=0 +y_0=0 +a=6377492.018 +units=km +no_defs',
...
workflow$modelOptions(INLA = list(control.inla=list(int.strategy = 'ccd',
