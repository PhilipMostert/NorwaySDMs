...
```{r covs, echo = FALSE, eval = TRUE}

#workflow$addCovariates(worldClim = 'tavg', res = 2.5, Function = scale)
tavg <- terra::rast('~/desktop/tavg.tiff')
workflow$addCovariates(tavg)
grassland <- terra::rast('~/Desktop/grassland.tiff')
workflow$addCovariates(Object = grassland)
